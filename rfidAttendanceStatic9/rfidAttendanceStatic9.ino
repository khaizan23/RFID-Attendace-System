...
void checkTemperature(int read)
{
  ...
  if (temp > bodyTemp)
  {
    ...
    lcd.setCursor(0, 1); // Move cursor to character 2 on line 1
    lcd.print(temps);
    tone(Active_buzzer, 450); // DO note 523 Hz
    delay(2000);
...
void openGate()
{
  tone(Active_buzzer, 1000); // DO note 523 Hz
  delay(500);
  noTone(Active_buzzer);  
